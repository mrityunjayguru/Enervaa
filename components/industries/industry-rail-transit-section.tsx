...
import {
  railTransitDetailData,
  IndustryDetailSectionData,
} from "@/lib/site-data";

interface IndustryRailTransitSectionProps {
  data?: IndustryDetailSectionData;
  className?: string;
}

export default function IndustryRailTransitSection({
  data = railTransitDetailData,
  className = "",
}: IndustryRailTransitSectionProps) {
