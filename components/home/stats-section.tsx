  ...
  return (
    <section className="w-full bg-white py-16 sm:py-20 lg:py-28 overflow-hidden">
      <div className="px-4 sm:px-6 lg:px-8 xl:px-12 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16 xl:gap-28">
        ...
        <div className="w-full flex-1 grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-y-10 sm:gap-y-14 lg:gap-y-16 gap-x-8 sm:gap-x-10 lg:gap-x-12 xl:gap-x-12">
