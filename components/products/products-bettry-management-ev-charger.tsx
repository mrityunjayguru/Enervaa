...
import { evChargingSystemsData, lowVoltageManagementData } from '@/lib/site-data'

type Props = {}

const ProductsBettryManagementEvCharger = (props: Props) => {
  return (
              ...
              <div className="max-w-2xl">
                <AnimateIn variant="fade-up" delay={0}>
                  <p className="text-xs sm:text-[16px] font-semibold tracking-wider text-[#78BA43] uppercase mb-4">
                    4 PRODUCTS &middot; BUILT TO APPLICATION
                  </p>
                </AnimateIn>
              ...
              <div className="max-w-xl lg:pt-6">
                <AnimateIn variant="fade-up" delay={150}>
                  <p className="text-[15px] sm:text-lg text-black mb-8 max-w-4xl">
                   AC and DC charging hardware, designed and manufactured in India, with an OCPP-native management platform behind it.
                  </p>
                </AnimateIn>
              </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10 mt-14 sm:mt-18">
              {evChargingSystemsData.map((product, idx) => (
                <AnimateIn
                  key={product.id}
                  variant="fade-up"
                  delay={150 + idx * 80}
...
export default ProductsBettryManagementEvCharger
